...
{/* ?      <Explore/> */}
    ...
    <Topgames />
      ...
      {
        tournaments.map(({bannerImgUrl,mode,title,PrizePool,slot,id,id_game,schd},i)=>{
          return <div key={i} >
          <Post banner={bannerImgUrl} gameID={id_game} schd={schd} id={id} mode={mode} title={title} prize={PrizePool} slot={slot} />
          </div>
        })
      }
      </section>
